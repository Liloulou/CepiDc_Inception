...
def get_params():
    params = defaultdict(
        # Input params
        default_batch_size=3,  # Maximum number of tokens per batch of examples.
        default_batch_size_tpu=32768,
        max_length=120,  # Maximum number of tokens per example.
        icd_file='data/cim10.txt',


        # Model params
        initializer_gain=1.0,  # Used in trainable variable initialization.
        vocab_size=7407,  # Number of tokens defined in the vocabulary file.
        kernel=3,
        hidden_size=12,  # Model dimension in the hidden layers.
